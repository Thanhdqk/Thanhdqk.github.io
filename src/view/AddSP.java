...
public class AddSP extends javax.swing.JFrame {
    ...
    public void setNewJFrame(String tenSP, String soLuong, Date ngayTao, String trangThai, String maKho){
        ...
        btnHuyBo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-x-25.png")));
    ...
    // Sử dụng mã sản phẩm mới khi thêm sản phẩm vào cơ sở dữ liệu
    public void addProductToDatabase() {
    // Tạo mã sản phẩm mới
    String newProductCode = generateNewProductCode();

    // Lấy các giá trị còn lại từ các trường khác
    String tenSP = txtTenSanPham.getText();
    int soLuong = Integer.parseInt(txtSoLuong.getText()); // Thay txtSoLuong bằng trường tương ứng của bạn
    ...
    try {
        // Kết nối đến cơ sở dữ liệu
        Connection connection = DriverManager.getConnection("jdbc:sqlserver://localhost;databaseName=SUPERDuAn1;encrypt=false;trustservercertificate=true", "sa", "123");
        ...
        statement.setDate(4, new java.sql.Date(txtNgayNhap.getDate().getTime()));
        statement.setString(5, trangThai);
        statement.setString(6, maKho);
...
private String tenHinhAnh;
    ...
    //JFileChooser chooser = new JFileChooser(getClass().getResource() + File.separator + "icon");
    String userDir = System.getProperty("user.dir");
    JFileChooser chooser = new JFileChooser(userDir + "\\icon");
    //JFileChooser chooser = new JFileChooser(getClass().getResource("/icon").getFile());
